...
use App\Models\LivingConditionsData;
...
class LivingConditionsDataController extends Controller
{
    /**
     * Mostrar lista de informacion de viviendaes.
     *
    ...
    public function index(Response $response)
    {
        ...
        try {
            $auth = Auth::user();
            $list = LivingConditionsData::orderBy('id', 'desc');
            if ($auth->role_id > 1) $list = $list->where("active", true);
            $list = $list->get();

            $response->data = ObjResponse::SuccessResponse();
            $response->data["message"] = 'Peticion satisfactoria | Lista de informacion de viviendaes.';
            $response->data["result"] = $list;
        } catch (\Exception $ex) {
            $msg = "LivingConditionsDataController ~ index ~ Hubo un error -> " . $ex->getMessage();
            Log::error($msg);
    ...
    public function selectIndex(Response $response)
    {
        $response->data = ObjResponse::DefaultResponse();
        try {
            $list = LivingConditionsData::where('active', true)
            ...
            $msg = "LivingConditionsDataController ~ selectIndex ~ Hubo un error -> " . $ex->getMessage();
            Log::error($msg);
            $response->data = ObjResponse::CatchResponse($msg);
        }
        return response()->json($response, $response->data["status_code"]);
    ...
    public function indexByFolio(Request $request, Response $response, String $folio)
    {
        ...
        try {
            ...
            $list = LivingConditionsData::where("active", true)->where('situation_id', $situation->id)->orderBy('id', 'desc')->first();

            $response->data = ObjResponse::SuccessResponse();
            $response->data["message"] = 'Peticion satisfactoria | Lista de informacion de viviendaes.';
            $response->data["result"] = $list;
        } catch (\Exception $ex) {
            $msg = "LivingConditionsDataController ~ indexByFolio ~ Hubo un error -> " . $ex->getMessage();
            Log::error($msg);
            $response->data = ObjResponse::CatchResponse($msg);
        }
        return response()->json($response, $response->data["status_code"]);
    ...
    public function createOrUpdate(Request $request, Response $response, Int $id = null)
    {
        ...
        try {
            ...
            $livingData = LivingConditionsData::find($id);
            if (!$livingData) {
                $livingData = new LivingConditionsData();
            }

            $livingData->fill($request->all());
            $livingData->save();
            ...
            $msg = "LivingConditionsDataController ~ createOrUpdate ~ Hubo un error -> " . $ex->getMessage();
            Log::error($msg);
            $response->data = ObjResponse::CatchResponse($msg);
        }
        return response()->json($response, $response->data["status_code"]);
    ...
    public function show(Request $request, Response $response, String $column, String $value, bool $internal = false)
    {
        $response->data = ObjResponse::DefaultResponse();
        try {
            $LivingConditionsData = LivingConditionsData::where($column, $value)->first();
            // Log::info("SitationController ~ show ~ LivingConditionsData" . json_encode($LivingConditionsData));
            $livingData = $LivingConditionsData::with([
                'requester',
                'beneficiary',
                'subcategory',
                // 'situationSetting',
                ...
                'documentsData',
                'evidencesData'
            ])->findOrFail($LivingConditionsData->id);

            if ($internal) return $livingData;
            // Log::info("SitationController ~ show ~ situtation" . json_encode($livingData));

            $response->data = ObjResponse::SuccessResponse();
            $response->data["message"] = 'peticion satisfactoria | informacion de vivienda encontrada.';
            $response->data["result"] = $livingData;
        } catch (\Exception $ex) {
            $msg = "LivingConditionsDataController ~ show ~ Hubo un error -> " . $ex->getMessage();
            Log::error($msg);
            $response->data = ObjResponse::CatchResponse($msg);
        }
        return response()->json($response, $response->data["status_code"]);
    ...
    public function delete(Response $response, Int $id)
    {
        $response->data = ObjResponse::DefaultResponse();
        try {
            LivingConditionsData::where('id', $id)
                ->update([
                    'active' => false,
            ...
            $msg = "LivingConditionsDataController ~ delete ~ Hubo un error -> " . $ex->getMessage();
            Log::error($msg);
            $response->data = ObjResponse::CatchResponse($msg);
        }
        return response()->json($response, $response->data["status_code"]);
    ...
    public function disEnable(Response $response, Int $id, string $active)
    {
        ...
        try {
            ...
            $msg = "LivingConditionsDataController ~ disEnable ~ Hubo un error -> " . $ex->getMessage();
            Log::error($msg);
            $response->data = ObjResponse::CatchResponse($msg);
        }
        return response()->json($response, $response->data["status_code"]);
    ...
    public function deleteMultiple(Request $request, Response $response)
    {
        ...
        try {
            ...
            LivingConditionsData::whereIn('id', $request->ids)->update([
                'active' => false,
                'deleted_at' => date('Y-m-d H:i:s'),
            ]);
            $response->data = ObjResponse::SuccessResponse();
            ...
            $msg = "LivingConditionsDataController ~ deleteMultiple ~ Hubo un error -> " . $ex->getMessage();
            Log::error($msg);
            $response->data = ObjResponse::CatchResponse($msg);
        }
        return response()->json($response, $response->data["status_code"]);
