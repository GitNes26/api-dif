...
return new class extends Migration
{
    ...
    public function up(): void
    {
        DB::statement(
            ...
            SELECT e.*, vwu.username, vwu.email, vwu.role_id, vwu.role, vwu.read, vwu.create, vwu.update, vwu.delete, vwu.more_permissions, vwu.page_index, vww.workstation, vww.department_id, vww.department 
            FROM employees e
